...
public class ResultsPageView extends BaseAdapter {
    ...
    public ResultsPageView(Context context, ArrayList<VotingEventClass> title){
        mContext = context;
        titleArray = title;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if(convertView == null){
            convertView = layoutInflater.inflate(R.layout.resultspageview, null);
        }
        ...
        goCandidates.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                BackgroundGetResultsCandidates bgc= new BackgroundGetResultsCandidates(mContext);
                bgc.execute(User.getInstance().resultsEventsList.get(position).getId());
