...
public class CandidateResultPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final CustomCandidateResultRecyclerAdapter adapter = new CustomCandidateResultRecyclerAdapter(User.getInstance().candidatesList,this);
