...
public class CustomCandidateResultRecyclerAdapter extends RecyclerView.Adapter<CustomCandidateResultRecyclerAdapter.CustomViewHolder> implements Filterable {
    ...
    CustomCandidateResultRecyclerAdapter.CustomFilter filter;



    public CustomCandidateResultRecyclerAdapter(ArrayList<CandidatesClass> items, Context c) {
        this.items = items;
        ctx=c;
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new CustomViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.grid_candidate2,parent,false));
    }

    @Override
    public void onBindViewHolder(final CustomCandidateResultRecyclerAdapter.CustomViewHolder holder, final int position) {
      ...
      //  Url=Url.concat("/SE/SignUpFile.php");
        ...
        holder.voteCount.setText("Votes: "+String.valueOf(item.getVotesCount()));


        if(item.getVotesCount()==0)
        {
            holder.vote.setText("Election Tie");
        }
        else
        {
            holder.vote.setText("Winner");
        }
    ...
    static class CustomViewHolder extends RecyclerView.ViewHolder{
        ...
        public CustomViewHolder(View itemView) {
            ...
            voteCount=(TextView)itemView.findViewById(R.id.votesCount);
