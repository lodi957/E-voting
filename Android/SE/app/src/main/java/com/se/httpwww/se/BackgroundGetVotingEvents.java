...
public class BackgroundGetVotingEvents extends AsyncTask<String,Void,String> {
    ...
    BackgroundGetVotingEvents(Context ctx) {
        context = ctx;
    ...
    protected String doInBackground(String... params) {
        ...
        address=address.concat("/SE/GetVotingEvents.php");
    ...
    protected void onPostExecute(String result) {
        ...
        {
            Intent intent = new Intent(context,VotingPage.class);
