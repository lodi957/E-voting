...
public class BackgroundEmail extends AsyncTask<String,Void,String> {

    Context context;
    AlertDialog alertDialog;

    BackgroundEmail(Context ctx) {
        context = ctx;
    }
    ...
    protected String doInBackground(String... params) {
        ...
        reg_url=reg_url.concat("/SE/EmailSuccess.php");
    ...
    protected void onPostExecute(String result) {
      ...
      //  alertDialog.setMessage(result);
       // alertDialog.show();
        ...
        BackgroundSMS backgroundSMS = new BackgroundSMS(context);
        backgroundSMS.execute();
