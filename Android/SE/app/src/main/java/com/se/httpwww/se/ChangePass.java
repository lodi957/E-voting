...
public class ChangePass extends AsyncTask<String,Void,String> {
    ...
    protected String doInBackground(String... params) {
        ...
        reg_url=reg_url.concat("/SE/ChangePasswordFile.php");
        ...
        if (method.equals("changePass")) {
            try {
                ...
                String currS = params[3];
                String u= User.getInstance().getName();
                String p= User.getInstance().getPass();
                ...
                String post_data = URLEncoder.encode("newp", "UTF-8") + "=" + URLEncoder.encode(newp, "UTF-8") + "&"
                        ...
                        + URLEncoder.encode("currS", "UTF-8") + "=" + URLEncoder.encode(currS, "UTF-8") + "&"
                        + URLEncoder.encode("user", "UTF-8") + "=" + URLEncoder.encode(u, "UTF-8") + "&"
                        + URLEncoder.encode("pass", "UTF-8") + "=" + URLEncoder.encode(p, "UTF-8");
    ...
    protected void onPostExecute(String result) {
        ...
        if(result!=null && result.contains("Complete success"))
        {
        ...
        else if(result==null || !result.contains("Complete success"))
        {
