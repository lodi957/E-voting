...
public class BackgroundGetVotingResults extends AsyncTask<String,Void,String> {
    ...
    BackgroundGetVotingResults(Context ctx) {
        context = ctx;
    ...
    protected String doInBackground(String... params) {
        ...
        address=address.concat("/SE/GetVotingResults.php");
            ...
            try {
                ...
                //    JSONObject jo = new JSONObject(result);
                 //   JSONArray ja = jo.getJSONArray("result");
                    ...
                    User.getInstance().resultsEventsList.clear();
                    ...
                    for(int i=0;i<ja.length();i++)
                    {
                       ...
                       // eid="1";
                        ...
                        User.getInstance().resultsEventsList.add(new VotingEventClass(id,name,desc,ins,pos));
    ...
    protected void onPostExecute(String result) {
        ...
        if(User.getInstance().resultsEventsList.size()==0){
